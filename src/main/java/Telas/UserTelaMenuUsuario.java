...
public class UserTelaMenuUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtReservado, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(46, 46, 46))
        );
    ...
    private void btnReservarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReservarActionPerformed
        //JOptionPane.showMessageDialog(null, txtReservado.getText());
        String reservadoAux = txtReservado.getText();
        int reservado = Integer.parseInt(reservadoAux);
        //JOptionPane.showMessageDialog(null, txtReservado);
        if (reservado==0) {
    ...
    private void tableConsultaLivrosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableConsultaLivrosMouseClicked
        ReservarLivro rl = new ReservarLivro();
        rl.selecionarLivros(tableConsultaLivros, txtId, txtReservado);
